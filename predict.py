...
parser.add_argument('--image', type=str, default='demo.png', required=False, help='The image you want to predict on. ')
parser.add_argument('--checkpoint_path', type=str, default="checkpoints/latest_model_BiSeNet_RainCloud.ckpt", required=False, help='The path to the latest checkpoint weights for your model.')
...
parser.add_argument('--dataset', type=str, default="RainCloud", required=False, help='The dataset you are using')
...
output_image = cv2.resize(np.array(output_image[0,:,:,:]), (512, 256))
